                        ...
                        <div className="gap-y-6">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    className="bg-transparent px-2 py-1 border border-gray-600 text-red-500"
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <textarea
                                    ...
                                    className="bg-transparent px-2 py-1 h-24 overflow-y-scroll resize-none border border-gray-600 text-red-500"
